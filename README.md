...
```bash
git clone https://github.com/amineichou/libft.git
```
...
## LICENSE
<p>
This work is published under the terms of <a href="https://github.com/amineichou/libft/blob/main/LICENSE.md">MIT LICENSE</a>.
</p>